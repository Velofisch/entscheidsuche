...
#            referenz = sel.xpath('.//acronym/text()').extract_first()
            ...
            referenz = 'NE-trican-'+referenz+'-'+str(self.schleife)+'.html'
#            print 'Referenz: '+referenz

#            time.sleep(5)
#            referenz = sel.xpath('normalize-space(.//td[@class="resultValue"]/a/acronym/text())').extract_first()
